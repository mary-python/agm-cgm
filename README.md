...
- After each dataset has been analyzed, the tables are printed in the terminal and the plots are saved in the same folder as the Python files. This should happen after a few minutes.
